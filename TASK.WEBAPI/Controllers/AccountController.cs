...
using TASK.WEBAPI.ViewModels.Identity;
...
namespace TASK.WEBAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private readonly PINBOARDContext db;
        public AccountController(UserManager<IdentityUser> userManager, IConfiguration config, PINBOARDContext db)
        {
